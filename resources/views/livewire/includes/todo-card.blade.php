    ...
    <div class="col-span-1 px-5 py-6 mb-5 bg-white border-t-2 border-blue-500 todo card hover:shadow">
        <div class="flex justify-between space-x-2">
            ...
            <div class="flex items-center space-x-2">
                <button wire:click="edit({{ $todo->id }})" class="text-sm font-semibold text-teal-500 rounded hover:text-teal-800">
                ...
                <button wire:click="delete({{ $todo->id }})" class="mr-1 text-sm font-semibold text-red-500 rounded hover:text-teal-800">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" class="w-4 h-4">
                        <path stroke-linecap="round" stroke-linejoin="round"
